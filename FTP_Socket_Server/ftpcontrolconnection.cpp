                                           ...
                                           const QMap<QString, bool> &mapFileLimit) : QObject(parent)
{
    ...
    QMap<QString, QString>::iterator it = this->mapServerSetting.find("UserName");
    userName = it.value();
    ...
    connect(socket,&QTcpSocket::readyRead,this,&FtpControlConnection::AcceptNewData);
    connect(socket,&QTcpSocket::disconnected,this,&FtpControlConnection::deleteLater);
    currentDirectory = "/";
